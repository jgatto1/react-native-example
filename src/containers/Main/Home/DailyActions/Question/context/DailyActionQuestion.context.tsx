...
// import { mockOkReq } from 'service/__mock__';
// import { POWER_UPS } from 'containers/Main/Home/DailyActions/Question/__mock__';
import { useCohortTopic } from 'containers/Main/Home/CohortTopic.context';

interface DailyActionQuestionContext {
  powerUp?: PowerUp;
  noMore?: boolean;
  refresh?: () => void;
}

const Context = React.createContext<DailyActionQuestionContext>({});

export const useDailyActionQuestionContext = () => useContext(Context);

export const DailyActionQuestionContextProvider: React.FC = ({ children }) => {
