declare module '@viro-community/react-viro' {
  ...
  interface ViroBoxProps {
    ...
    physicsBody?: {
      ...
      enabled?: boolean;
      velocity?: number[];
      force?: { value?: number[]; position?: number[] }[] | { value?: number[]; position?: number[] };
      torque?: number[];
    };
    viroTag?: string;
  ...
  interface ViroParticleEmitterProps {
    ...
    spawnBehavior?: {
      ...
      maxParticles?: number;
      emissionBurst?:
        | { time?: number; min?: number; max?: number; cycles?: number; cooldownPeriod?: number }
        | { distance?: number; min?: number; max?: number; cycles?: number; cooldownDistance?: number }[];
      spawnVolume?: { shape?: string; params?: number[]; spawnOnSurface?: boolean };
    };
    particleAppearance?: {
      opacity?: {
        initialRange?: number[];
    ...
    particlePhysics?: {
      ...
      explosiveImpulse?: { impulse?: number; position?: number[]; decelerationPeriod?: number };
    };
  }
  ...
  interface ViroARSceneProps {
    displayPointCloud?:
      | { imageSource?: { uri?: string } | number; imageScale?: number[]; maxPoints?: number }
      | boolean;
    ignoreEventHandling?: boolean;
